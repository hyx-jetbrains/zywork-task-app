...
/**
 * WeixinUserCertificationDO数据对象实体类<br/>
 *
 * 创建于2019-04-03<br/>
 *
 ...
 * @version 1.0
 */
public class WeixinUserCertificationDO extends BaseDO {

    private static final long serialVersionUID = -9223372036818974744L;
    ...
    public String toString() {
        return "WeixinUserCertificationDO {" +
