 ...
 * @version 1.0
 */
public class WeixinTaskApplyDO extends BaseDO {

    private static final long serialVersionUID = -9223372035761376187L;
    ...
    public WeixinTaskApplyDO () {}

    public WeixinTaskApplyDO (Long id, Long taskId, Long userId, Byte pubConfirmStatus, Date pubConfirmTime, Byte appConfirmStatus, Date appConfirmTime, Date createTime, Date updateTime, Integer version, Byte isActive) {
        this.id = id;
		this.taskId = taskId;
		this.userId = userId;
