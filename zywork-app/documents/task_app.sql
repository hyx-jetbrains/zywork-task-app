...
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户账目明细表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_funds_recharge`  (
  ...
  `is_active` tinyint(4) NULL DEFAULT 0 COMMENT '是否激活',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户资金充值记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_funds_transfer`  (
  ...
  `is_active` tinyint(4) NULL DEFAULT 0 COMMENT '是否激活',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户资金转入与转出记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_funds_withdraw`  (
  ...
  `is_active` tinyint(4) NULL DEFAULT 0 COMMENT '是否激活',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户资金提现记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_funds_withdraw_check`  (
  ...
  `is_active` tinyint(4) NULL DEFAULT 0 COMMENT '是否激活',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户资金提现审核历史表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `t_scheduler` VALUES (1, 'DauSaveJob', 'top.zywork.job.DauSaveJob', '59 59 23 * * ?', 'job_group', 'trigger_name', 'trigger_group', NULL, 1, '2019-04-15 11:35:53', 1, 313, '2019-01-18 17:34:42', '2019-04-15 11:35:53', 0);
...
CREATE TABLE `t_sys_log`  (
  ...
  `is_active` tinyint(4) NULL DEFAULT 0 COMMENT '是否激活',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 329 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统操作日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_user_bankcard`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户银行卡记录表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `t_user_detail` VALUES (31, 'Sys Super Admin', NULL, 0, NULL, NULL, NULL, NULL, NULL, 'upload/image/user/2019040919140232268.png', NULL, NULL, 'nxrLRk', 7, '2018-12-22 15:46:43', '2019-04-09 19:14:02', 0);
...
CREATE TABLE `t_weixin_certification`  (
  ...
  `is_active` tinyint(4) NULL DEFAULT 0 COMMENT '是否激活',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '微信认证' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_weixin_task`  (
  ...
  `is_active` tinyint(4) NULL DEFAULT 0 COMMENT '是否激活',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '微信任务' ROW_FORMAT = Dynamic;
...
INSERT INTO `t_weixin_task` VALUES (5, 31, '测试任务发布', 10, 0, 1000, '微信加友，微信绑定银行卡，使用时间超过半年', 1, '2019-04-12 09:48:34', '2019-04-12 13:33:23', 1, 0);
...
CREATE TABLE `t_weixin_task_appeal`  (
  ...
  `is_active` tinyint(4) NULL DEFAULT 0 COMMENT '是否激活',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '微信任务申诉' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_weixin_task_apply`  (
  ...
  `is_active` tinyint(4) NULL DEFAULT 0 COMMENT '是否激活',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '微信任务报名' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_weixin_task_apply
-- ----------------------------
INSERT INTO `t_weixin_task_apply` VALUES (3, 3, 36, 1, '2019-04-12 13:27:27', 0, NULL, '2019-04-11 16:17:56', '2019-04-12 13:27:27', 5, 0);
INSERT INTO `t_weixin_task_apply` VALUES (4, 6, 36, 1, '2019-04-12 14:37:17', 1, '2019-04-12 14:49:20', '2019-04-12 14:35:54', '2019-04-12 14:49:19', 5, 0);
