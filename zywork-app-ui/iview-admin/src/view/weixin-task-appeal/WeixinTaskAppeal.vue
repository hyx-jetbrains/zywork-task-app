...
<FormItem label="申诉用户编号" prop="userId">
	<InputNumber v-model="form.userId" placeholder="请输入申诉用户编号" style="width: 100%;"/>
</FormItem>
<FormItem label="申诉描述" prop="appealDes">
	<Input v-model="form.appealDes" placeholder="请输入申诉描述"/>
</FormItem>
<FormItem label="申诉状态" prop="appealStatus">
	<InputNumber v-model="form.appealStatus" placeholder="请输入申诉状态" style="width: 100%;"/>
</FormItem>
<FormItem label="处理时间" prop="handleTime">
	<DatePicker @on-change="form.handleTime=$event" :value="form.handleTime" placeholder="请输入处理时间" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
  ...
  export default {
    ...
    data() {
      return {
        ...
        urls: {
          addUrl: '/weixin-task-appeal/admin/save',
          batchAddUrl: '/weixin-task-appeal/admin/batch-save',
          editUrl: '/weixin-task-appeal/admin/update',
          batchEditUrl: '/weixin-task-appeal/admin/batch-update',
          searchUrl: '/weixin-task-appeal/admin/pager-cond',
          allUrl: '/weixin-task-appeal/admin/all',
          removeUrl: '/weixin-task-appeal/admin/remove/',
          batchRemoveUrl: '/weixin-task-appeal/admin/batch-remove',
          detailUrl: '/weixin-task-appeal/admin/one/',
          activeUrl: '/weixin-task-appeal/admin/active',
          batchActiveUrl: '/weixin-task-appeal/admin/batch-active'
        },
        page: {
          total: 0
        },
