		...
		<Modal v-model="modal.add" title="添加" @on-visible-change="changeModalVisibleResetForm('addForm', $event)">
			<Form ref="addForm" :model="form" :label-width="80" :rules="validateRules">
				...
				<FormItem label="微信认证图片" prop="url">
					<Input v-model="form.url" placeholder="请输入微信认证图片" />
				</FormItem>
				<FormItem label="认证状态" prop="checkStatus">
					<InputNumber v-model="form.checkStatus" placeholder="请输入认证状态" style="width: 100%;" />
				</FormItem>
				<FormItem label="认证时间" prop="checkTime">
					<DatePicker @on-change="form.checkTime=$event" :value="form.checkTime" placeholder="请输入认证时间" type="datetime"
					...
					<Row>
						<i-col span="11">
							<FormItem prop="checkTimeMin">
								<DatePicker @on-change="searchForm.checkTimeMin=$event" :value="searchForm.checkTimeMin" placeholder="请输入开始认证时间"
						...
						<i-col span="11">
							<FormItem prop="checkTimeMax">
								<DatePicker @on-change="searchForm.checkTimeMax=$event" :value="searchForm.checkTimeMax" placeholder="请输入结束认证时间"
								 type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
							</FormItem>
						</i-col>
					</Row>
	...
	export default {
		...
		data() {
			return {
				...
				urls: {
					addUrl: '/weixin-certification/admin/save',
					batchAddUrl: '/weixin-certification/admin/batch-save',
					editUrl: '/weixin-certification/admin/update',
					batchEditUrl: '/weixin-certification/admin/batch-update',
					searchUrl: '/weixin-certification/admin/pager-cond',
					allUrl: '/weixin-certification/admin/all',
					removeUrl: '/weixin-certification/admin/remove/',
					batchRemoveUrl: '/weixin-certification/admin/batch-remove',
					detailUrl: '/weixin-certification/admin/one/',
					activeUrl: '/weixin-certification/admin/active',
					batchActiveUrl: '/weixin-certification/admin/batch-active'
				},
				page: {
					total: 0
				},
